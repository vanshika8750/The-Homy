      ...
      <CustomizationProvider>
        <Router>
          ...
          <Routes>
            ...
            <Route
              exact
              path="/dustguard/homypro"
              element={<DustguardHomypro />}
            />
            <Route
              exact
              path="/dustguard/homypromax"
              element={<DustguardHomypromax />}
            />
            <Route exact path="/hygiene/homy" element={<HygieneHomy />} />
            <Route exact path="/hygiene/homypro" element={<HygieneHomypro />} />
            <Route
              exact
              path="/hygiene/homypromax"
              element={<HygieneHomypromax />}
            />
