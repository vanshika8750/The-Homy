...
const Aboutus = () => {
  return (
    <div className="aboutus content-below-navbar" >
...
>
    ...
    <div className="aboutus-cards" >
        ...
        <div className="card" >
        <p className='first-para'>We are <span style={{fontWeight:"200px"}}>Hoomy household services private limited</span>! The luxury service provider for your comfort</p>
